...
class ProxyManager {
  ...
  writeEnvConfig(tmp0) {
    ...
    const fn = (arg0, arg1) => {
      ...
      tmp6.push("", "# ─── " + arg1 + " ───");
      tmp6.push(arg0 + "BASE_URL=" + (tmp0[arg0 + "BASE_URL"] || ""));
